...
import { selectGenre, selectTitle } from "@/redux/features/searchFilter/selector";

interface FilmsListProps {
    films: Film[]
}

export const FilmsList: FunctionComponent<FilmsListProps> = ({ films }): ReactNode => {
    ...
    return (
        <div>
            {filteredFilms.map(film => <FilmCard.Small key={film.id} film={film} />)}
        </div>
    )
};