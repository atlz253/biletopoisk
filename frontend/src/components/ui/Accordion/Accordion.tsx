...
const AccordionContext = createContext<{ active: string | null, setActive: Dispatch<SetStateAction<string | null>> }>({ active: null, setActive: () => undefined });
...
Accordion.Group = function AccordionGroupComponent({ title, children }): ReactNode {
    ...
    return (
        <Card
            className={classNames("padding-md", "cursor-pointer", "user-select-none", styles.group)}
            onClick={onClick}
        >
