...
export const FilmCardSmall: FunctionComponent<FilmCardProps> = ({ film, removable }): ReactNode => {
                ...
                <div className={classNames("margin-left", styles.content)}>
                    <div>
                        ...
                        <div className={styles.genre}>
                            <i className="text-transform-capitalize font-weight-500">{translate(film.genre, "ru")}</i>
                        </div>
                    </div>
